    ...
    try {
        ...
        if (process.env.CASHFREE_MODE === 'PRODUCTION') {
            if (returnUrl.includes('localhost')) {
                returnUrl = returnUrl.replace(/http:\/\/localhost:\d+/, 'https://crunchyho.in');
        ...
        if (!response.data.payment_session_id) {
            console.warn("Cashfree Response missing payment_session_id:", response.data);
            return res.status(500).json({
                message: 'Payment session not generated by Cashfree',
